...
// Format ringkas untuk label sumbu Y, contoh: 1.2jt, 850rb
...
export default function RevenueChart({ data = [], loading = false, subtitle = 'Tren pendapatan dari pesanan' }) {
    ...
    >
      ...
      >
          <div className="flex items-start gap-2">
            <Wallet size={16} style={{ color: '#34d399', marginTop: '2px' }} />
            <div>
              <h3 className="text-sm font-bold" style={{ color: '#ffffff', margin: 0 }}>Pendapatan</h3>
              <p className="text-xs" style={{ color: '#64748b', margin: '1px 0 0 0' }}>{subtitle}</p>
            </div>
          </div>
